        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-auto pb-20">
          ...
          >
            ...
            <h3 className="font-display text-[clamp(1.8rem,4vw,3rem)] font-light
              ...
              Pronti quando
              <br /><span className="text-gold">lo sei tu.</span>
            </h3>
            <p className="font-sans text-[13.5px] text-neutral-600 mb-10 leading-relaxed max-w-sm">
              Lascia la tua email e ti ricontattiamo entro 24 ore con una proposta
        ...
        <div className="overflow-hidden">
          ...
          >
            <span
              ...
              style={{
                fontSize: 'clamp(5.5rem, 17vw, 19rem)',
                lineHeight: 0.85,
